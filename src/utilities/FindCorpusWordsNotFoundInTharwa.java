...
/**
 * This Java calss aims to find the DA words in parallel data (EGY and MSA) which are not found in Tharwa CODA column.
 */
public class FindCorpusWordsNotFoundInTharwa {
    ...
    public static Vector<String> buildTharwaDAList(String TharwaPath, boolean AlefYaNormalized, boolean diacritized) throws IOException
    {
        ...
        while ((LineToRead =tharwaReader.readLine()) != null)
        {
           ...
           /////////////////////////////////////
            ...
            System.out.print("Tharwa Entry MSA data index  "+ tharwaMSAIndex+"\n");
    ...
    {
        System.out.print("Building EGY data list started.....\n");
        ...
        dataWriter.flush();
        dataWriter.close();
        System.out.print("Building EGY data list finished.....\n");
        System.out.print("Number of EGY words: "+ wordsList.size()+"\n");
        return wordsList;
    ...
    public static void compare(Vector<String> TharwaList, Vector<String> EGYDataList) throws IOException
    {
        ...
        System.out.print("Comparing tharwa and EGY list started...\n");
        int counter=0;
        for (String EGYWord: EGYDataList)
        {
            counter++;
            if (counter%10000==0)
                System.out.print("Number of EGY words compared  "+counter+"\n");
        ...
        System.out.print("Comparing tharwa and EGY list finished...\n");
